...
class _OtherDepartmentState extends State<OtherDepartment> {
  ...
  void calculator(String course, String score, String credit) {
    setState(() {
      ...
      if ((scorePoint >= 90) && (scorePoint <= 100)) {
        ...
        numberGrade = 2.5;
        latterGrade = 'C+';
      } else if ((scorePoint >= 50) && (scorePoint < 60)) {
        numberGrade = 2;
        latterGrade = 'C';
      } else if ((scorePoint >= 45) && (scorePoint < 50)) {
        numberGrade = 1.75;
        latterGrade = 'C-';
      } else if ((scorePoint >= 40) && (scorePoint < 45)) {
        numberGrade = 1;
        latterGrade = 'D';
      } else if ((scorePoint >= 0) && (scorePoint < 40)) {
        numberGrade = 0;
        latterGrade = 'F';
      }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          title: const Text('other Departments'),
          centerTitle: true,
        ),
        body: ListView(
          children: [
